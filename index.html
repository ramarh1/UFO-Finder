...
<body class="bg-dark">
    ...
    <div class="container-fluid">
          ...
          <div class="col-md-3">
            <form class="bg-dark">
                ...
                <ul class="list-group, bg-dark">
                    ...
                    <li class="list-group-item, bg-dark">
                        <label for="date">Enter City</label>
                        <input type="text" placeholder="miami" id="city" />
                    </li>
                    <li class="list-group-item, bg-dark">
                        <label for="date">Enter State</label>
                        <input type="text" placeholder="florida" id="state" />
                    </li>
                    <li class="list-group-item, bg-dark">
                        <label for="date">Enter Country</label>
      ...
      <script src="https://cdnjs.cloudflare.com/ajax/libs/d3/4.11.0/d3.js", crossorigin="anonymous"></script>
      <script src="static/css/js/data.js"></script>
      <script src="static/css/js/app.js"></script>
